        ...
        <div style={styles.card}>
          ...
          {success && (
            <div style={styles.successBox}>
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#6ee7b7" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              {success}
            </div>
          )}
...
const styles = {
  ...
  orb1: { position:'absolute', top:'-10%', left:'-5%', width:'500px', height:'500px', borderRadius:'50%', background:'radial-gradient(circle, rgba(59,130,246,0.08) 0%, transparent 70%)', pointerEvents:'none' },
  orb2: { position:'absolute', bottom:'-10%', right:'-5%', width:'400px', height:'400px', borderRadius:'50%', background:'radial-gradient(circle, rgba(16,185,129,0.05) 0%, transparent 70%)', pointerEvents:'none' },
  container: { width:'100%', maxWidth:'420px', zIndex:10 },
  card: { background:'rgba(255,255,255,0.03)', backdropFilter:'blur(24px)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'24px', padding:'36px 32px', boxShadow:'0 30px 60px rgba(0,0,0,0.6)' },
  cardTitle: { fontSize:'22px', fontWeight:700, color:'#fff', margin:0, textAlign:'center' },
  cardSub: { color:'rgba(255,255,255,0.4)', fontSize:'13px', marginTop:'8px', marginBottom:'28px', textAlign:'center', lineHeight:'1.5' },
  ...
  input: { flex:1, background:'transparent', border:'none', color:'#fff', fontSize:'14px', fontFamily:"'Inter', sans-serif", outline:'none' },
  ...
  link: { color:'#60a5fa', textDecoration:'none', fontWeight:600, fontSize:'14px' },
};

      ...
      <div style={styles.page}>
        ...
        <div style={styles.body}>
          ...
          <div style={styles.topBar}>
            <button onClick={() => router.push('/leads')} style={styles.backBtn}><IconBack /> Back to Leads</button>
          </div>
              ...
              <div style={styles.panel}>
                <div style={styles.panelHead}>
                  ...
                  <button onClick={handleAIScore} disabled={scoringAI} style={styles.aiBtn}
                    onMouseEnter={e => { if(!scoringAI) e.currentTarget.style.background='#f3e8ff'; }}
...
const styles = {
  ...
  aiBtn:      { display:'flex', alignItems:'center', gap:'6px', background:'#faf5ff', border:'1px solid #e9d5ff', color:'#7e22ce', borderRadius:'10px', padding:'8px 14px', fontSize:'13px', fontWeight:700, cursor:'pointer', fontFamily:"'Inter',sans-serif", transition:'all 0.15s', boxShadow:'0 1px 2px rgba(0,0,0,0.05)' },
  ...
  miniSpinner:{ width:'14px', height:'14px', border:'2px solid rgba(59,130,246,0.3)', borderTop:'2px solid #3b82f6', borderRadius:'50%', display:'inline-block', marginRight:'6px' },

...
const StatCard = ({ icon, label, value, sub, color, delay }) => (
  <div style={{ ...styles.card, animationDelay: delay }} className="stat-card">
    ...
    <div style={styles.cardBody}>
      ...
      <p style={{ ...styles.cardValue, color: color.value || '#0f172a' }}>{value}</p>
              ...
              <div style={styles.bottomGrid}>
                ...
                <div style={styles.panel}>
                  ...
                  <div style={styles.revenueList}>
                    {[
                      { label: 'Total Pipeline Value', value: fmt(stats.totalDealValue), color: '#3b82f6' },
                      { label: 'Won Revenue',          value: fmt(stats.wonDealValue),   color: '#10b981' },
                      { label: 'At Risk (Lost)',        value: fmt(stats.lostDealValue || 0), color: '#ef4444' },

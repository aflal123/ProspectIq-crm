        ...
        <div className="desktop-only" style={styles.desktopUserBox}>
          {user.name && (
            <span style={styles.userName}>
              <UserCircle size={18} color="#3b82f6" /> {user.name}
            </span>
          )}
          <motion.div
            ...
            <div style={styles.mobileMenuContent}>
              ...
              >
                <div style={styles.mobileUserRow}>
                  ...
                  <span style={{ fontSize: '16px', fontWeight: 600, color: '#0f172a' }}>{user.name || 'User'}</span>
                </div>
                <button
...
const styles = {
  ...
  userName: { color: '#475569', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '6px', fontWeight: 600, fontFamily: "'Inter', sans-serif" },
